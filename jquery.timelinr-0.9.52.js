...
jQuery.fn.timelinr = function(options){
	...
	$(function(){
		...
		if(settings.orientation == 'horizontal') {	
			...
			$(settings.datesDiv).width(widthDate*howManyDates).css('marginLeft',widthContainer/6-widthDate/6);
...
$(document).ready(function(){
			$('#click1').click(function(){
				$('#click1').css({'color': '#FFCC00', 'font-size': '38px'}); 
				$('#click2').css({'color': '#FFFFCC', 'font-size': '28px'});
				$('#click3').css({'color': '#FFFFCC', 'font-size': '28px'});
				$('#click4').css({'color': '#FFFFCC', 'font-size': '28px'});
				$('#click5').css({'color': '#FFFFCC', 'font-size': '28px'});
			});
			$('#click2').click(function(){
				$('#click1').css({'color': '#FFFFCC', 'font-size': '28px'}); 
				$('#click2').css({'color': '#FFCC00', 'font-size': '38px'});
				$('#click3').css({'color': '#FFFFCC', 'font-size': '28px'});
				$('#click4').css({'color': '#FFFFCC', 'font-size': '28px'});
				$('#click5').css({'color': '#FFFFCC', 'font-size': '28px'});
			});
			$('#click3').click(function(){
				$('#click1').css({'color': '#FFFFCC', 'font-size': '28px'}); 
				$('#click2').css({'color': '#FFFFCC', 'font-size': '28px'});
				$('#click3').css({'color': '#FFCC00', 'font-size': '38px'});
				$('#click4').css({'color': '#FFFFCC', 'font-size': '28px'});
				$('#click5').css({'color': '#FFFFCC', 'font-size': '28px'});
			});
			$('#click4').click(function(){
				...
				$('#click2').css({'color': '#FFFFCC', 'font-size': '28px'});
				$('#click3').css({'color': '#FFFFCC', 'font-size': '28px'});
				$('#click4').css({'color': '#FFCC00', 'font-size': '38px'});
				$('#click5').css({'color': '#FFFFCC', 'font-size': '28px'});
			});
			$('#click5').click(function(){
				...
				$('#click3').css({'color': '#FFFFCC', 'font-size': '28px'});
				$('#click4').css({'color': '#FFFFCC', 'font-size': '28px'});
				$('#click5').css({'color': '#FFCC00', 'font-size': '38px'});
			});
		});