...
jQuery.fn.timelinr = function(options){
	...
	$(function(){
		...
		if(settings.orientation == 'horizontal') {	
			...
			$(settings.datesDiv).width(widthDate*howManyDates).css('marginLeft',widthContainer/10-widthDate/10);
...
/****================ Highlight Year On Click ================****/

$(document).ready(function(){
			$('#click1').click(function(){
				$('#click1').css({'color': '#FFCC00', 'font-size': '20px'}); 
				$('#click2').css({'color': '#FFFFCC', 'font-size': '16px'});
				$('#click3').css({'color': '#FFFFCC', 'font-size': '16px'});
				$('#click4').css({'color': '#FFFFCC', 'font-size': '16px'});
				$('#click5').css({'color': '#FFFFCC', 'font-size': '16px'});
			});
			$('#click2').click(function(){
				$('#click1').css({'color': '#FFFFCC', 'font-size': '16px'}); 
				$('#click2').css({'color': '#FFCC00', 'font-size': '20px'});
				$('#click3').css({'color': '#FFFFCC', 'font-size': '16px'});
				$('#click4').css({'color': '#FFFFCC', 'font-size': '16px'});
				$('#click5').css({'color': '#FFFFCC', 'font-size': '16px'});
			});
			$('#click3').click(function(){
				$('#click1').css({'color': '#FFFFCC', 'font-size': '16px'}); 
				$('#click2').css({'color': '#FFFFCC', 'font-size': '16px'});
				$('#click3').css({'color': '#FFCC00', 'font-size': '20px'});
				$('#click4').css({'color': '#FFFFCC', 'font-size': '16px'});
				$('#click5').css({'color': '#FFFFCC', 'font-size': '16px'});
			});
			$('#click4').click(function(){
				...
				$('#click2').css({'color': '#FFFFCC', 'font-size': '16px'});
				$('#click3').css({'color': '#FFFFCC', 'font-size': '16px'});
				$('#click4').css({'color': '#FFCC00', 'font-size': '20px'});
				$('#click5').css({'color': '#FFFFCC', 'font-size': '16px'});
			});
			$('#click5').click(function(){
				...
				$('#click3').css({'color': '#FFFFCC', 'font-size': '16px'});
				$('#click4').css({'color': '#FFFFCC', 'font-size': '16px'});
				$('#click5').css({'color': '#FFCC00', 'font-size': '20px'});
			});
		});